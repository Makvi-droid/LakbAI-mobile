...
interface SpotDetailSheetProps {
  ...
  onToggleSave?: (spot: MapSpot) => void;
}
      ...
      <Pressable style={styles.backdrop} onPress={onClose}>
        <Pressable style={styles.sheet} onPress={(e) => e.stopPropagation()}>
          ...
          <TouchableOpacity
            ...
            onPress={() => onToggleSave?.(spot)}
          >
            <Ionicons
              name={isSaved ? "bookmark" : "bookmark-outline"}
              size={18}
              color={isSaved ? "#13A7E8" : "#111827"}
            />
          </TouchableOpacity>
          ...
          <View style={styles.content}>
            <View style={styles.headerRow}>
              ...
              <View style={styles.crowdPill}>
                <View style={[styles.crowdDot, { backgroundColor: CROWD_COLORS[spot.crowd] }]} />
            ...
            <TouchableOpacity style={styles.askBtn} onPress={() => onAskLakbAI(spot)} activeOpacity={0.85}>
...
const styles = StyleSheet.create({
  ...
  sheet: { backgroundColor: "#fff", borderTopLeftRadius: 24, borderTopRightRadius: 24, overflow: "hidden", paddingBottom: 24 },
  ...
  saveBtn: {
    position: "absolute", top: 14, right: 54, width: 32, height: 32, borderRadius: 16,
    backgroundColor: "#fff", alignItems: "center", justifyContent: "center",
    shadowColor: "#000", shadowOpacity: 0.15, shadowRadius: 4, elevation: 3,
  },
  ...
  crowdPill: { flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: "#F3F4F6", borderRadius: 12, paddingHorizontal: 8, paddingVertical: 4 },
  ...
  tag: { backgroundColor: "#EFF6FF", borderRadius: 10, paddingHorizontal: 10, paddingVertical: 4 },
  tagText: { fontSize: 12, fontWeight: "600", color: "#3B82F6" },
  description: { fontSize: 14, color: "#4B5563", lineHeight: 20, marginTop: 14 },
  askBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: "#111827", borderRadius: 16, paddingVertical: 14, marginTop: 18 },
